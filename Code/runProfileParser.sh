...
if [ "$HOSTNAME" = "manipa" ]; then
    ...
    make clean
    make
    mkdir -p parserResults/CPUPhi
    echo "Testing parser/scorer on CPU and GPU"
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkEP.txt profileEntertainmentPolitical.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkEF.txt profileEntertainmentFinancial.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkEI.txt profileEntertainmentInternational.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkEW.txt profileEntertainmentWashington.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkSP.txt profileSportsPolitical.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkSF.txt profileSportsFinancial.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkSI.txt profileSportsInternational.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkSW.txt profileSportsWashington.bin
    ./opencl_full_fork > parserResults/CPUPhi/opencl_full_forkUP.txt profileUSAPolitical.bin
