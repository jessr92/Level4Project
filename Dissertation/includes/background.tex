...
used in the experiments, there are five streaming multi-processors (SMX) which
have a private L1 cache. All SMXs share a L2 cache.
...
where $term_k$ is sixty bits and $h_j$ hashes sixty bits into ($log_2 S_{BF}$)
bits
