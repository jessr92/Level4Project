...
a warp experience a cache miss, the warp will have to wait for the few threads
with a hit to retrieve their value from memory, removing all benefit from the
bloom filter miss by the other threads.
