...
running at 1.053GHz, and the cores are 4-way hyper-threaded resulting in 240
...
2.0 slot with 8x lane bandwidth giving a total theoretical bandwidth between its
on-board memory and main memory of 4GB/s (500MB/ per lane).
