...
improve throughput overall given that the parser is the bottleneck. For the
parsing and scoring kernel, the data transfer time reduction is beneficial as
the CPU isn't the bottleneck given that it has no real computation to execute.
